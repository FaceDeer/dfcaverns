...
local lava_sea_crystal_biome_def = {
	...
	y_min = df_caverns.config.lava_sea_min,
	y_max = df_caverns.config.lava_sea_max,
	heat_point = 60,
	humidity_point = 30,
...
local airspace = (df_caverns.config.lava_sea_max - df_caverns.config.lava_sea_min) / 2.75
local lava_sea_level = df_caverns.config.lava_sea_max - airspace
...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	if minp.y > lava_sea_level or maxp.y < df_caverns.config.lava_sea_min then
		return
	end
