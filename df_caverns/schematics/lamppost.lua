local n1 = { name = "df_mapitems:slade_block", force_place=true }
...
local n6 = { name = "df_mapitems:slade_seal", force_place=true }
local n7 = { name = "stairs:stair_slade_brick", param2 = 1, force_place=true }
local n8 = { name = "df_mapitems:slade_brick", force_place=true }
local n9 = { name = "stairs:stair_slade_brick", param2 = 3, force_place=true }
local n10 = { name = "df_mapitems:slade_wall", force_place=true }
